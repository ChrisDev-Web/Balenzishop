...
export default function CartDropdown({ onClose, variant = 'anchored' }) {
  ...
  const { isMayorista, minQuantity } = useUserPricing()
  ...
  return (
    <div className={panelClass} role="dialog" aria-label="Carrito de compras">
      {variant === 'anchored' && (
      ...
      <div className="flex shrink-0 items-center justify-between border-b px-5 py-4">
        ...
        <button type="button" onClick={onClose} className="text-gray-400 hover:text-gray-600" aria-label="Cerrar carrito">
          <X className="h-5 w-5" />
        </button>
      </div>
