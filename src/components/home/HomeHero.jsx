...
const FRAME_CLASS =
  'relative w-full overflow-hidden max-xl:aspect-[4/5] max-xl:max-h-[88vh] xl:aspect-auto xl:min-h-[70vh]'
...
export default function HomeHero({ backgroundImage, priority = true }) {
  ...
  return (
    <section className="relative w-full max-xl:bg-stone-100 xl:bg-stone-200">
      <div className={FRAME_CLASS}>
        {showSkeleton && (
          <Skeleton className="absolute inset-0 z-[1] rounded-none max-xl:min-h-[88vh] xl:min-h-[70vh]" />
        )}
        ...
        <div
          className="pointer-events-none absolute inset-x-0 top-0 z-[2] h-24 bg-gradient-to-b from-black/40 to-transparent xl:hidden"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 z-[2] h-[38%] bg-gradient-to-t from-white/85 via-white/35 to-transparent xl:hidden"
          aria-hidden="true"
        />
        <div
          className={`pointer-events-none absolute inset-0 z-[2] hidden bg-gradient-to-t from-black/80 via-black/25 to-black/10 xl:block xl:from-black/75 xl:via-black/20 xl:to-transparent ${
        ...
        <div
          className={`hero-banner-content-enter pointer-events-auto absolute inset-x-0 bottom-0 z-10 px-6 pb-10 text-center xl:hidden ${
        ...
        <div
          className={`hero-banner-content-enter pointer-events-auto absolute inset-x-0 bottom-0 z-10 hidden px-6 pb-10 sm:px-10 sm:pb-14 xl:block xl:px-16 xl:pb-20 2xl:px-20 2xl:pb-24 ${
            showContent ? '' : 'pointer-events-none opacity-0'
          }`}
        >
          <div className="max-w-xl text-left">
            ...
            <h1 className="font-nav mt-3 text-2xl font-semibold uppercase leading-tight tracking-[0.1em] text-white sm:text-3xl xl:text-4xl 2xl:text-5xl">
              Tu fragancia perfecta te espera
            </h1>
