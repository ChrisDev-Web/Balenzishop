    ...
    (set, get) => ({
      ...
      addOrder: (order) => {
        ...
        const newOrder = {
          ...
          couponRedeemed: order.couponRedeemed ?? false,
      ...
      updateOrder: (orderId, orderData) => {
        ...
        const orders = (user.orders || []).map((o) => {
          ...
          return {
            ...
            couponRedeemed: orderData.couponRedeemed ?? o.couponRedeemed ?? false,
            paymentMethodId: orderData.paymentMethodId ?? o.paymentMethodId ?? null,
            paymentMethodName: orderData.paymentMethodName ?? o.paymentMethodName ?? null,
